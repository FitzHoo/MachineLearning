...
composition_leverage_factor = -comp_lev_fac['factor']
composition_leverage_factor.name = 'leverage'
with open("composition_leverage_factor.pkl", 'wb') as f:
    pickle.dump(composition_leverage_factor, f)

composition_growth_factor = comp_gro_fac['factor']
composition_growth_factor.name = 'growth'
with open("composition_growth_factor.pkl", 'wb') as f:
    pickle.dump(composition_growth_factor, f)

composition_volatility_factor = comp_vol_fac['factor']
composition_volatility_factor.name = 'growth'
with open("composition_volatility_factor.pkl", 'wb') as f:
    pickle.dump(composition_volatility_factor, f)

composition_quality_factor = comp_qua_fac['factor']
composition_quality_factor.name = 'quality'
with open("composition_quality_factor.pkl", 'wb') as f:
    pickle.dump(composition_quality_factor, f)

composition_volatility_factor = comp_vol_fac['factor']
composition_volatility_factor.name = 'volatility'
with open("composition_volatility_factor.pkl", 'wb') as f:
    pickle.dump(composition_volatility_factor, f)

composition_valuation_factor = -comp_val_fac['factor']
composition_valuation_factor.name = "valuation"
with open("composition_valuation_factor.pkl", 'wb') as f:
    pickle.dump(composition_valuation_factor, f)

composition_scale_factor = -comp_sca_fac['factor']
composition_scale_factor.name = 'scale'
with open("composition_scale_factor.pkl", 'wb') as f:
    pickle.dump(composition_scale_factor, f)

composition_tech_factor = -comp_tech_fac['factor']
composition_tech_factor.name = 'tech'
with open("composition_tech_factor.pkl", 'wb') as f:
    pickle.dump(composition_tech_factor, f)